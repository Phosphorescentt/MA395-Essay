...
G.add_edge(2, 4, color="black")
G.add_edge(3, 4, color="black")
G.add_edge(4, 5, color="white")
G.add_edge(5, 6, color="black")
G.add_edge(5, 7, color="black")
G.add_edge(6, 8, color="black")
...
nx.draw(G, pos, width=5, edge_color=colours, node_color="#000000", node_size=500)
