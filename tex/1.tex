...
\begin{figure}
    \begin{center}
        % \includegraphics[width=0.95\textwidth]{}
        \missingfigure{Rendering of Some Internet Dataset}
    \end{center}
...
\todo[backgroundcolor=brown]{After this point I couldn't really find anything concrete to relate these things to commmunity detection. Could it be woth removing them?}
